...
def ask_question(state: models.InterviewState):
    ...
    response, state["rate_limit_exceeded"] = get_structured_output(messages_for_llm, models.Question, state["rate_limit_exceeded"])
...
def create_search_query(state: models.InterviewState):
    ...
    response, state["rate_limit_exceeded"] = get_structured_output(prompt, models.SearchQuery, state["rate_limit_exceeded"])
...
def answer_question(state: models.InterviewState):
    ...
    result, state["rate_limit_exceeded"] = get_structured_output(prompt, models.Response, state["rate_limit_exceeded"])
...
def create_interview_report(state: models.InterviewState):
    ...
    response, state["rate_limit_exceeded"] = get_structured_output(llm_messages, models.Report, state["rate_limit_exceeded"])
...
def create_report_introduction(state: models.OverallState):
    ...
    response, state["rate_limit_exceeded"] = get_structured_output(prompt, models.Introduction, state["rate_limit_exceeded"])
...
def create_report_body(state: models.OverallState):
    ...
    response, state["rate_limit_exceeded"] = get_structured_output(prompt, models.ReportBody, state["rate_limit_exceeded"])
    return {"report_body": response.report_body}
